//Modified from: https://cdn.jsdelivr.net/gh/lit/dist@3/all/lit-all.min.js
function generate_lit(){
  /**
 * @license
...
return {Ht: Ht, Bt: Bt, n: n, Vt: Vt, ut: ut, Mt: Mt, $: $, mt: mt, ps: ps, ws: ws, ft: ft, ct: ct, h: h, Zt: Zt, Wt: Wt, Ft: Ft, Gt: Gt, Jt: Jt, kt: kt, ns: ns, o: o, w: w, Ut: Ut, Pt: Pt, c: c, _t: _t, Yt: Yt, Z: Z, Qt: Qt, Tt: Tt, gt: gt, wt: wt, yt: yt, pt: pt, St: St, bt: bt, Xt: Xt, ts: ts, Es: Es, ss: ss, is: is, F: F, _: _, G: G, es: es, hs: hs, At: At, at: at, ls: ls, xt: xt, Ct: Ct, As: As, ks: ks, ds: ds, s: s, q: q, fs: fs, r: r, vs: vs, ms: ms, xs: xs, _s: _s, Ss: Ss, Ps: Ps}
}
LIT_DICT = generate_lit()
AsyncDirective=LIT_DICT.Ht
AsyncReplaceDirective=LIT_DICT.Bt
CSSResult=LIT_DICT.n
Directive=LIT_DICT.Vt
LitElement=LIT_DICT.ut
PartType=LIT_DICT.Mt
ReactiveElement=LIT_DICT.$
TemplateResultType=LIT_DICT.mt
UnsafeHTMLDirective=LIT_DICT.ps
UntilDirective=LIT_DICT.ws
_$LE=LIT_DICT.ft
_$LH=LIT_DICT.ct
adoptStyles=LIT_DICT.h
asyncAppend=LIT_DICT.Zt
asyncReplace=LIT_DICT.Wt
cache=LIT_DICT.Ft
choose=LIT_DICT.Gt
classMap=LIT_DICT.Jt
clearPart=LIT_DICT.kt
createRef=LIT_DICT.ns
css=LIT_DICT.o
defaultConverter=LIT_DICT.w
directive=LIT_DICT.Ut
getCommittedValue=LIT_DICT.Pt
getCompatibleStyle=LIT_DICT.c
getDirectiveClass=LIT_DICT._t
guard=LIT_DICT.Yt
html=LIT_DICT.Z
ifDefined=LIT_DICT.Qt
insertPart=LIT_DICT.Tt
isCompiledTemplateResult=LIT_DICT.gt
isDirectiveResult=LIT_DICT.wt
isPrimitive=LIT_DICT.yt
isServer=LIT_DICT.pt
isSingleExpression=LIT_DICT.St
isTemplateResult=LIT_DICT.bt
join=LIT_DICT.Xt
keyed=LIT_DICT.ts
literal=LIT_DICT.Es
live=LIT_DICT.ss
...
range=LIT_DICT.es
ref=LIT_DICT.hs
removePart=LIT_DICT.At
render=LIT_DICT.at
repeat=LIT_DICT.ls
setChildPartValue=LIT_DICT.xt
setCommittedValue=LIT_DICT.Ct
staticHtml=LIT_DICT.As
staticSvg=LIT_DICT.ks
styleMap=LIT_DICT.ds
supportsAdoptingStyleSheets=LIT_DICT.s
svg=LIT_DICT.q
templateContent=LIT_DICT.fs
unsafeCSS=LIT_DICT.r
unsafeHTML=LIT_DICT.vs
unsafeSVG=LIT_DICT.ms
unsafeStatic=LIT_DICT.xs
until=LIT_DICT._s
when=LIT_DICT.Ss
withStatic=LIT_DICT.Ps
